...
#
# Changelog:
# Version 2.1.1 - 04 Jun 2026
#       Merged upstream Noriben v2.0.1 - v2.0.3 into this fork:
#           Logging now uses the standard logging library
#           --cmd now accepts a full command line with arguments
#           Allow execution on non-Windows solely to process premade CSV files
#           Added --disable-file-hash to skip hashing created files
#           File checking now only approves regular files; file hashing reads
#           in chunks instead of loading the whole file into memory
#           Updated PMC filters and approvelists for Windows 11
#       Fixed two bugs found while integrating upstream:
